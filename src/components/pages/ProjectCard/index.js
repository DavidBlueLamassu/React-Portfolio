...
//react to find and to display them as I discovered in an article from "Level Up Coding": Lorenzo Zarantonello, "Display 
//Images In React", Level Up Coding (17 January 2023), last viewed 14 March 2023: 
//https://levelup.gitconnected.com/display-images-in-react-8ff1f5b1cf9a Harshvardhan Singh Baghel's answer to a question
//on "Stack Overflow" was also helpful: Zip, "How do I reference a local image in React?", Stack Overflow (12 October 2016), 
//last viewed 14 March 2023: https://stackoverflow.com/questions/39999367/how-do-i-reference-a-local-image-in-react
function ProjectCard(props) {
  return ( 
    <article className="col-lg-4 col-md-6 col-sm-12" style={styles.cardPosition}> {/* Class name ensures that divs are responsive */}
